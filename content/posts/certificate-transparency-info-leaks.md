...
As the company deployment flow become more complicated, the company will start using tools like [`cert-manager`](https://cert-manager.io/). Once done, the entire certificate and subdomains flow creation is automated, and there is almost nothing to be done by humans. 
...
When I contacted _Let's Encrypt_, they have basically told me people should be aware of this and it's their own problem. 
